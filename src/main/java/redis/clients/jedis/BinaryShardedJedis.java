...
public class BinaryShardedJedis extends Sharded<Jedis, JedisShardInfo> implements
  ...
  @Override
  public String calcGeotargeting(String bucket, long geotargetingId, double latitude, double longitude, int radius) {
    throw new NotImplementedException();
  }

  @Override
  public String deleteGeotargeting(String bucket, long geotargetingId) {
    throw new NotImplementedException();
  }
